        ...
        {/* <div className='container flex'>
            <div className='header-content'>
                ...
                <div className='btn-groups flex'>
                  <button type = "button" className='btn-item bg-brown fw-4 ls-2'><a href="#services">Services</a></button>
                  <button type = "button" className='btn-item bg-dark fw-4 ls-2'><a href="#contact">Contact Us</a></button>
                </div>
            </div>
        </div> */}
    </div>
